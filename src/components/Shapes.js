...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#00c180" position={[15, 10, -2]} intensity={0.5} />
      <spotLight color="#00c180" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#00c759" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
